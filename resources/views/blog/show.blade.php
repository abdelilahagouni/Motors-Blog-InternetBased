...
<a href="/blog/{{ $post->slug }}/edit" class="bg-green-700 text-green-100 mt-6 inline-block py-4 pc-5 rounded-lg font-bold uppercase text-lg place-self-start">Edit Post </a>
 <form action="/blog/{{ $post->slug }}" method="post" class="inline-block">
    @csrf
    @method('delete')
    <button type="submit"  class="bg-red-700 text-red-100 mt-6 inline-block py-4 pc-5 rounded-lg font-bold uppercase text-lg place-self-start">delete Post </button>
